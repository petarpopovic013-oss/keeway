export default function Location() {
  ...
  return (
    <section id="posetite-nas" className="bg-background py-16 md:py-section-gap px-margin-mobile md:px-gutter w-full border-t border-white/5 select-none">
      <div className="max-w-container-max mx-auto">
        {/* Title Header */}
        <div className="text-left md:text-center mb-12 md:mb-16">
          <h2 className="font-montserrat text-3xl md:text-5xl text-primary uppercase tracking-tight font-bold font-normal ![text-shadow:none] ![-webkit-text-stroke:0]">
            Kako do nas?
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-stretch mt-8">
              ...
              <div className="flex flex-col gap-6 font-inter text-[15px] font-light">
                ...
                <div className="flex items-start gap-4 text-on-surface-variant hover:text-primary transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@keeway.rs" className="hover:underline text-primary">
                      info@keeway.rs
                    </a>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 w-full h-[250px] md:h-[350px] lg:h-auto min-h-[250px] md:min-h-[350px] relative border border-white/5 overflow-hidden">
            <iframe
              src={mapEmbedUrl}
              width="100%"
              height="100%"
              ...
              className="w-full h-full min-h-[250px] md:min-h-[350px] grayscale contrast-125 brightness-95 opacity-80 hover:grayscale-0 hover:opacity-100 hover:brightness-100 transition-all duration-700 ease-in-out"
              title="Keeway Novi Sad lokacija mapi"
            ></iframe>
          </div>
        </div>
      </div>
