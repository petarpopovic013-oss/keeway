    ...
    <>
      ...
      <main className="flex-grow flex flex-col w-full bg-white pt-24 min-h-screen selection:bg-track-cyan selection:text-black">
        <article className="container mx-auto px-6 max-w-5xl py-20">
          ...
          <Link 
            href="/novosti"
            className="inline-flex items-center gap-3 text-gray-500 hover:text-black font-zuume font-normal italic uppercase tracking-widest text-[11px] font-bold mb-16 transition-all hover:-translate-x-1"
          >
          ...
          <header className="mb-16">
            <div className="flex items-center gap-3 text-track-cyan font-saira text-sm mb-6 border-l-2 border-track-cyan pl-4">
            ...
            <h1 className="text-5xl md:text-7xl font-zuume font-normal italic text-black uppercase tracking-tighter leading-[1.1] ![text-shadow:none] ![-webkit-text-stroke:0]">
              {newsItem.title}
            </h1>
          </header>
          ...
          <div className="max-w-3xl mx-auto mb-24">
            <div className="prose prose-lg md:prose-xl prose-p:font-saira prose-p:text-gray-600 prose-p:leading-relaxed prose-headings:font-zuume font-normal italic prose-headings:uppercase prose-headings:tracking-tight prose-a:text-track-cyan whitespace-pre-wrap">
              {newsItem.content}
            </div>
          </div>
          ...
          {galleryImages.length > 0 && (
            <div className="border-t-2 border-black pt-16">
              <h3 className="text-2xl font-zuume font-normal italic uppercase tracking-tight mb-8">
                Galerija
              </h3>
