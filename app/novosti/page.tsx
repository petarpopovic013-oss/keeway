      ...
      <main className="flex-grow flex flex-col w-full bg-white pt-24 min-h-screen">
        <div className="container mx-auto px-6 max-w-7xl py-20 flex-grow flex flex-col">
          <div className="border-b-2 border-black pb-8 mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-zuume font-normal italic text-black uppercase tracking-tight ![text-shadow:none] ![-webkit-text-stroke:0]">
              Novosti
            </h1>
          </div>
              ...
              {newsList.map((item) => (
                <div key={item.id} className="group flex flex-col bg-white border border-gray-200 hover:border-black transition-all duration-300">
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    <span className="text-track-cyan font-saira tracking-widest text-[9px] font-bold uppercase mb-4 block">
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-100">
                      <Link 
                        ...
                        className="flex items-center gap-2 text-black hover:text-track-cyan font-zuume font-normal italic uppercase tracking-widest text-[10px] font-bold transition-all duration-300"
                      >
                        PROČITAJ VIŠE
