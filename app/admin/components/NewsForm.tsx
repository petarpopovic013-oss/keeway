    ...
    <div className="max-w-4xl mx-auto py-12">
      ...
      >
        ...
        <div className="bg-gray-50 p-8 border border-gray-200">
          <div className="grid grid-cols-1 gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">Naslov *</label>
                <input 
              ...
              <div>
                <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">Slug (URL) *</label>
                <input 
            ...
            <div>
              <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">Datum *</label>
              <input 
            ...
            <div>
              <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">Tekst vesti *</label>
              <textarea 
                required value={content} onChange={(e) => setContent(e.target.value)} rows={10}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none transition-all font-saira text-sm resize-none" 
                placeholder="Unesite tekst vesti..."
              />
            </div>
            
            <div>
              <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">Slike (maksimalno 3)</label>
        ...
        <div className="flex justify-end gap-4">
          <button type="button" onClick={() => router.back()} className="px-8 py-4 bg-gray-200 text-black font-zuume font-normal italic uppercase text-sm tracking-widest hover:bg-gray-300 transition-colors">
            Otkaži
          </button>
          <button type="submit" disabled={isPending} className="px-8 py-4 bg-black text-white font-zuume font-normal italic uppercase text-sm tracking-widest hover:bg-red-600 transition-colors disabled:opacity-50">
