...
const InputLabel = ({ children }: { children: React.ReactNode }) => (
  <label className="block text-black text-[15px] font-zuume font-normal italic uppercase tracking-widest mb-2">
    {children}
  </label>
);
...
const SectionHeader = ({ title, num }: { title: string, num: string }) => (
  <div className="border-b-2 border-black pb-4 mb-8 mt-16 first:mt-0">
    <h2 className="text-3xl font-zuume font-normal italic text-black uppercase tracking-tight ![text-shadow:none] ![-webkit-text-stroke:0]">
      {num}. {title}
    </h2>
  </div>
);
...
export function MotorcycleForm({ initialData }: { initialData?: Motorcycle }) {
  ...
  const handleGalleryChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      const totalImages = existingGallery.length + newGalleryFiles.length + validFiles.length;
      if (totalImages > 3) {
        setError('Maksimalan broj slika u galeriji je 3.')
        window.scrollTo({ top: 0, behavior: 'smooth' })
        return
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        ...
        if (mainImage) {
          const compressedBlob = await convertToWebP(mainImage)
          const newFile = new File([compressedBlob], mainImage.name.replace(/\.[^/.]+$/, "") + ".webp", { type: 'image/webp' })
    ...
    <div className="max-w-4xl mx-auto py-12">
      ...
      >
        <AnimatePresence>
          {error && (
            ...
            >
              ...
              <p className="font-saira text-sm">{error}</p>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none transition-all font-saira text-sm" 
                placeholder='npr. "Keeway C652V"'
              />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-gray-100 border border-gray-200 px-5 py-4 text-gray-500 focus:outline-none transition-all cursor-not-allowed font-saira text-sm" 
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none transition-all font-saira text-sm appearance-none" 
              >
            ...
            <div className="md:col-span-2">
              ...
              <textarea 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none transition-all resize-none font-saira text-sm" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 650" />
            </div>
            <div>
              <InputLabel>Tip motora</InputLabel>
              <input 
                type="text" value={specs.engine_type} onChange={(e) => updateSpec('engine_type', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. V-2-cilindrični / 4-taktni..." />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 82×61.5" />
            </div>
            <div>
              <InputLabel>Snaga (KS)</InputLabel>
              <input 
                type="text" value={specs.power} onChange={(e) => updateSpec('power', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 55.76 pri 7500 o/min" />
            </div>
            <div>
              <InputLabel>Maks. obrtni moment</InputLabel>
              <input 
                type="text" value={specs.max_torque} onChange={(e) => updateSpec('max_torque', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 62.0 Nm pri 6000 o/min" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 10.3:1" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. EFI" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. SOHC" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. TCI" />
            </div>
            <div>
              <InputLabel>Starter</InputLabel>
              <input 
                type="text" value={specs.starter} onChange={(e) => updateSpec('starter', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Električni" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Podmazivanje pod pritiskom..." />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Tečnošću hlađen" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 6-stepeni" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Kaiš" />
            </div>
            <div>
              <InputLabel>Tip kvačila</InputLabel>
              <input 
                type="text" value={specs.clutch_type} onChange={(e) => updateSpec('clutch_type', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Proklizavajuće kvačilo..." />
            </div>
            <div>
              <InputLabel>TCS (Kontrola proklizavanja)</InputLabel>
              <input 
                type="text" value={specs.tcs} onChange={(e) => updateSpec('tcs', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Sistem kontrole proklizavanja" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Dupli cevasti" />
            </div>
            <div>
              <InputLabel>Prednji točak</InputLabel>
              <input 
                type="text" value={specs.front_wheel} onChange={(e) => updateSpec('front_wheel', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Aluminijumska legura" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 43mm okrenuta teleskopska viljuška" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 138" />
            </div>
            <div>
              <InputLabel>Prednja guma</InputLabel>
              <input 
                type="text" value={specs.front_tyre} onChange={(e) => updateSpec('front_tyre', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 130/70R18, CST" />
            </div>
            <div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Pro-link mono amortizer..." />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 48" />
            </div>
            <div>
              <InputLabel>Zadnja guma</InputLabel>
              <input 
                type="text" value={specs.rear_tyre} onChange={(e) => updateSpec('rear_tyre', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 200/55R16, CST" />
            </div>
            <div>
              <InputLabel>Prednja kočnica</InputLabel>
              <input 
                type="text" value={specs.front_brake} onChange={(e) => updateSpec('front_brake', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Dvostruki diskovi..." />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 300" />
            </div>
            <div>
              <InputLabel>Zadnja kočnica</InputLabel>
              <input 
                type="text" value={specs.rear_brake} onChange={(e) => updateSpec('rear_brake', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Disk, jednoklipna klešta" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 240" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 255" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 710" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 1645" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 2330" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 890" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 1115" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 145" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 18.5" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 170" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 180" />
            </div>
            <div>
              <InputLabel>Baterija</InputLabel>
              <input 
                type="text" value={specs.battery} onChange={(e) => updateSpec('battery', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. 12V, 14Ah" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Kontrola gasa sa dva kabla" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Uključeno" />
            </div>
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Type-A" />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. LED projektor + DRL" />
            </div>
            <div>
              <InputLabel>Zadnje svetlo</InputLabel>
              <input 
                type="text" value={specs.taillight} onChange={(e) => updateSpec('taillight', e.target.value)}
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. LED" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full bg-white border border-gray-300 px-5 py-4 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Uključeno, dvokanalni" />
            </div>
            <div>
        ...
        <div className="bg-gray-50 p-8 border border-gray-200">
          ...
          <p className="text-gray-500 font-saira text-sm mb-6">
          ...
          <div className="space-y-4">
              ...
              <div key={spec.id} className="flex flex-col md:flex-row gap-4 items-start md:items-end border-b border-gray-200 pb-4 last:border-0 last:pb-0">
                <div className="w-full md:w-1/4">
                  ...
                  <input 
                    ...
                    className="w-full bg-white border border-gray-300 px-4 py-3 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Multimedija" />
                </div>
                <div className="w-full md:w-1/3">
                  <InputLabel>Naziv polja</InputLabel>
                  <input 
                    type="text" value={spec.label} onChange={(e) => updateExtraSpec(spec.id, 'label', e.target.value)}
                    className="w-full bg-white border border-gray-300 px-4 py-3 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Grejači sedišta" />
                </div>
                <div className="w-full md:flex-1">
                  <InputLabel>Vrednost</InputLabel>
                  <input 
                    type="text" value={spec.value} onChange={(e) => updateExtraSpec(spec.id, 'value', e.target.value)}
                    className="w-full bg-white border border-gray-300 px-4 py-3 text-black focus:border-black focus:outline-none font-saira text-sm" placeholder="npr. Da" />
                </div>
                <button 
                  type="button" 
            ...
            <button 
              ...
              className="flex items-center gap-2 text-black font-zuume font-normal italic uppercase tracking-widest text-base hover:text-track-cyan transition-colors mt-4"
            >
              ...
              <div className="flex-1 w-full">
                <label className="flex flex-col items-center justify-center w-full aspect-[4/3] md:aspect-auto md:h-48 border-2 border-gray-300 border-dashed cursor-pointer hover:bg-white hover:border-black transition-all group bg-white/50">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-gray-500 group-hover:text-black transition-colors font-saira">
                      <span className="font-zuume font-normal italic text-black">Klikni</span> ili prevuci sliku
                    </p>
                  </div>
                  <input type="file" accept="image/*" onChange={handleMainImageChange} className="hidden" />
                </label>
                {mainImage && (
                  <p className="mt-3 text-xs text-black font-zuume font-normal italic uppercase tracking-widest flex items-center gap-2">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-2">
              ...
              <label className="flex flex-col items-center justify-center w-40 aspect-[4/3] border-2 border-gray-300 border-dashed cursor-pointer hover:bg-white hover:border-black transition-all group bg-white/50">
                ...
                <span className="text-[15px] text-gray-400 font-saira group-hover:text-black transition-colors uppercase tracking-widest font-bold">Dodaj sliku</span>
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4 pt-12 mt-12 border-t-2 border-black">
          <button 
            ...
            className="px-8 py-5 font-zuume font-normal italic uppercase tracking-widest text-base text-black hover:text-white hover:bg-black transition-colors border border-black w-full sm:w-auto text-center"
          >
            Odustani
          </button>
          <button 
            type="submit" 
            disabled={isPending}
            className="flex items-center justify-center gap-3 bg-black text-white px-10 py-5 font-zuume font-normal italic uppercase tracking-widest text-base hover:bg-track-cyan transition-colors duration-300 disabled:opacity-50 w-full sm:w-auto"
          >
            {isPending ? (
