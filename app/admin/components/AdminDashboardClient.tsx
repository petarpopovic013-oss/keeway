    ...
    <div className="py-12 max-w-7xl mx-auto">
      ...
      {motorcycles.length === 0 ? (
        ...
        >
          ...
          <h2 className="text-3xl font-zuume font-normal italic mb-4 uppercase tracking-tight text-black ![text-shadow:none] ![-webkit-text-stroke:0]">Baza je prazna</h2>
          ...
          {motorcycles.map((moto) => (
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col bg-white">
                ...
                <h3 className="text-2xl font-zuume font-normal italic mb-4 group-hover:text-track-cyan transition-colors uppercase tracking-tight text-black">
                  {moto.name}
                </h3>
