        ...
        <div className="max-w-[1440px] mx-auto px-6 py-5 flex justify-between items-center">
          ...
          >
            <div className="relative w-32 h-10 overflow-hidden flex items-center justify-center transition-all duration-300">
              <Image 
                src="/Keeway-Worldmark-Orange.png" 
                alt="Keeway Logo" 
                fill 
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/admin"
              className="flex items-center gap-2 font-saira text-base font-bold uppercase tracking-widest text-black hover:text-track-cyan transition-all duration-300"
            >
              <span>Motori</span>
            </Link>
            ...
            <form action={logout}>
              <button 
                type="submit" 
                className="flex items-center gap-2 font-saira text-base font-bold uppercase tracking-widest text-black hover:text-red-600 transition-all duration-300"
              >
