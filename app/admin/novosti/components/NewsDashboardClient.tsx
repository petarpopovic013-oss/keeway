    ...
    <div className="py-12 max-w-7xl mx-auto">
      ...
      >
        ...
        <Link 
          ...
          className="group flex items-center justify-center gap-3 bg-black text-white px-8 py-4 font-zuume font-normal italic uppercase tracking-widest text-base hover:bg-track-cyan transition-colors duration-300 w-full md:w-auto"
        >
      ...
      {newsList.length === 0 ? (
        ...
        >
          ...
          <h2 className="text-3xl font-zuume font-normal italic mb-4 uppercase tracking-tight text-black ![text-shadow:none] ![-webkit-text-stroke:0]">Nema vesti</h2>
            ...
            >
              <div className="relative aspect-[4/3] w-full bg-gray-100 overflow-hidden border-b border-gray-200">
                ...
                <div className="absolute bottom-4 right-4">
                  <span className="inline-block bg-track-cyan text-black text-base uppercase tracking-widest font-bold px-3 py-2 font-zuume font-normal italic">
              ...
              <div className="p-8 flex-1 flex flex-col bg-white">
                <h3 className="text-2xl font-zuume font-normal italic mb-4 group-hover:text-track-cyan transition-colors uppercase tracking-tight text-black line-clamp-2">
                  {item.title}
                </h3>
                ...
                <div className="mt-auto pt-6 border-t border-gray-100 flex items-center gap-4">
                  <Link 
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-gray-50 hover:bg-black text-black hover:text-white border border-gray-200 hover:border-black py-3 font-zuume font-normal italic uppercase tracking-widest text-[15px] transition-all duration-300"
                  >
                    IZMENI
